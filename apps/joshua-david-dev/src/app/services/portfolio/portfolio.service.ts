...
const baseUrl: string = "http://localhost:8080/api/portfolio";
...
export class PortfolioService {
  ...
  public get(id?: string | null, slug?: string | null): Observable<any> {
    return this.http.get(`${baseUrl}/${slug ? slug : id}`)
      .pipe(
